...
# ====================================================================
#  Single Decoder Baseline: Use only VLM (no separate experts)
#  This config is identical to the three-expert version, except:
#  1. Uses QwenVL3ASingleDecoderPlanningHead instead of QwenVL3APlanningHead
#  2. All tokens (LLM + perception + action) are processed by single decoder
# ====================================================================
...
model = dict(
    type='UniDriveVLA',
    planning_head=dict(
        type='QwenVL3ASingleDecoderPlanningHead',  # ✅ Single Decoder Head
