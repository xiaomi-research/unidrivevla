...
num_depth_layers = 3
drop_out = 0.1
temporal = False # Disable temporal
temporal_map = False # Disable temporal map
decouple_attn = True
...
model = dict(
    ...
    planning_head=dict(
        ...
        det_vla_head_cfg=dict(
            ...
            with_instance_id=False, # Disable instance_id for no-temporal mode
            instance_bank=dict(
                type="InstanceBank",
                num_anchor=900,
                ...
                num_temp_instances=0, # Disable temporal
                confidence_decay=0.6,
                feat_grad=False,
            ),
            anchor_encoder=dict(
            ...
            temp_graph_model=None, # Disable temporal
            graph_model=dict(
