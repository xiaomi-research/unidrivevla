...
model = dict(
    planning_head=dict(
        ...
        # 训练结束后 merge 并保存的目录。
        # LoRAMergeHook 会在 after_run 时自动调用，生成完整 HuggingFace 权重。
        lora_merge_save_dir='./work_dirs/unidrivevla_baseline_3b_exp157_baseline_final_vlm_direct_vel_hybrid_loss_lora_2b/lora_merged',
    ),
)
version = 'trainval'
