...
model = dict(
    ...
    planning_head=dict(
        ...
        pretrained_path='/high_perf_store3/world-model/yongkangli/ms-swift-main/megatron_output/Qwen3-VL-2B-Instruct-3-7/v4-20260201-222838/checkpoint-3069/',
        action_dim=2,
        action_horizon=6,
        dtype='bfloat16',
...
vad_ann_file_train = None
vad_ann_file_val = None
vad_ann_file_test = None
...
evaluation = dict(
    interval=num_iters_per_epoch * 10,
    eval_mode=eval_mode,
)
