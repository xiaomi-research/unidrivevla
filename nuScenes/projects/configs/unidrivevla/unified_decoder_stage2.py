...
#  - Enable motion task and motion losses
#  - 3 Stage1 layers + VLM + 3 Stage2 layers
# ====================================================================

# Load Stage1 checkpoint
load_from = "/high_perf_store3/world-model/yongkangli/UniDriveVLA/work_dirs/unidrivevla_baseline_3b_exp135_baseline_final_vlm_direct_three_loss/iter_6570/global_step1642/mp_rank_00_model_states.pt"
...
unified_decoder_cfg = dict(
    ...
    task_select=["det", "map", "ego", "motion"],  # Stage2: motion enabled
    ...
    graph_model=dict(
        ...
        query_select=["det", "map", "ego", "motion"],
        separate_list=[["det"], ["map"]],  # Stage2: motion added
        decouple_list=[True, False],  # Stage2: motion uses decouple
        attn=[
    ...
    temp_graph_model=dict(
        ...
        query_select=["det", "map", "ego", "motion"],
        query_list=[["det"], ["map"], ["ego"]],  # Motion has no temporal
    ...
    loss_motion_cls=dict(
        ...
        gamma=2.0,
        alpha=0.25,
        loss_weight=0.2,  # Stage2: motion loss enabled
    ),
    loss_motion_reg=dict(type="L1Loss", loss_weight=0.2),  # Stage2: enabled
...
model = dict(
    ...
    planning_head=dict(
        ...
        # Unified Decoder (Stage2: det + map + ego + motion)
