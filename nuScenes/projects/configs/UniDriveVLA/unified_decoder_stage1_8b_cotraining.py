...
model = dict(
    ...
    planning_head=dict(
        ...
        pretrained_path='/high_perf_store3/world-model/yongkangli/ms-swift-main/megatron_output/Qwen3-VL-8B-Instruct-3-7-with-his/v4-20260312-061536/checkpoint-3123/',
        action_dim=2,
        action_horizon=6,
        dtype='bfloat16',
        vlm_variant="8b",
...
ar_dataset_cfg = dict(
    ...
    # 驾驶数据
    jsonl_paths=[
            '/high_perf_store3/world-model/yongkangli/Dataset_vqa/LingoQA/qa_dataset_lingoqa_clean_packed2048.jsonl', #26319
            '/high_perf_store3/world-model/yongkangli/Dataset_vqa/DriveLM/drivelm_converted.with_prefix_packed2048.jsonl', #4071
            '/high_perf_store3/world-model/yongkangli/Dataset_vqa/Senna/senna_final_reordered_updated_token_fixed_packed2048.jsonl', # 27885
        ],
    max_length=2048,
    # 通用 VQA 数据
    vqa_jsonl_paths=['/high_perf_store3/world-model/yongkangli/finevision_subset_90k.jsonl'],
