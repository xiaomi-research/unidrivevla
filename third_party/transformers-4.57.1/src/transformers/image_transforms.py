...
def to_channel_dimension_format(
    ...
    input_channel_dim: Union[None, ChannelDimension, str] = None,
) -> np.ndarray:
    """
...
def group_images_by_shape(
    ...
    Dict[Tuple[int, int], List["torch.Tensor"]], Dict[Union[int, Tuple[int, int]], Tuple]
]:
    """
...
def reorder_images(
    ...
    grouped_images_index: Dict[Union[int, Tuple[int, int]], Tuple],
    is_nested: bool = False,
