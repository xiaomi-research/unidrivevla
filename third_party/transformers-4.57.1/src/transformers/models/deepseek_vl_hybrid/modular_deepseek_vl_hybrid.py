...
class DeepseekVLHybridImageProcessor(DeepseekVLImageProcessor):
    ...
    def __init__(
        ...
        high_res_image_mean: Union[None, float, List[float]] = None,
        high_res_image_std: Union[None, float, List[float]] = None,
...
class DeepseekVLHybridImageProcessorFast(DeepseekVLImageProcessorFast):
    ...
    def _preprocess(
        ...
        high_res_image_mean: Union[None, float, List[float]],
        high_res_image_std: Union[None, float, List[float]],
