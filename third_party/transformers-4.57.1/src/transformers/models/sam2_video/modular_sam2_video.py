...
class Sam2VideoInferenceSession:
    ...
    def store_output(
        ...
        output_value: Union[None, "torch.Tensor", dict] = None,
        ...
        Args:
            ...
            output_value (Union[None, "torch.Tensor", dict]): The value of the output.
...
class Sam2VideoProcessor(Sam2Processor):
    ...
    def add_inputs_to_inference_session(
        ...
        input_points: Union[None, List[List[List[List[float]]], "torch.Tensor"]] = None,
        input_labels: Union[None, List[List[List[int]], "torch.Tensor"]] = None,
        input_boxes: Union[None, List[List[List[float]], "torch.Tensor"]] = None,
