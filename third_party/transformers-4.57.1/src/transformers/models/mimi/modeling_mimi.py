...
class MimiOutput(ModelOutput):
    ...
    encoder_past_key_values: Union[None, Cache, List["torch.FloatTensor"]] = None
    decoder_past_key_values: Union[None, Cache, List["torch.FloatTensor"]] = None
...
class MimiTransformerModel(nn.Module):
    ...
    def forward(
        ...
        attention_mask: Optional["torch.Tensor"] = None,
        position_ids: Optional["torch.LongTensor"] = None,
        past_key_values: Union[None, Cache, List["torch.FloatTensor"]] = None,
