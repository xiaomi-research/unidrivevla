...
class ImageGPTFastImageProcessorKwargs(DefaultFastImageProcessorKwargs):
    ...
    clusters: Union[None, np.ndarray, List[List[int], "torch.Tensor"]]
...
class ImageGPTImageProcessorFast(BaseImageProcessorFast):
    ...
    def __init__(
        self,
        clusters: Union[None, list, np.ndarray, "torch.Tensor"] = None,  # keep as arg for backwards compatibility
    ...
    def _preprocess(
        ...
        clusters: Union[None, list, np.ndarray, "torch.Tensor"] = None,
