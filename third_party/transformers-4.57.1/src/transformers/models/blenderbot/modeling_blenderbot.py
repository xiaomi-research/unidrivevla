...
class BlenderbotPreTrainedModel(PreTrainedModel):
    ...
    def _update_causal_mask(
        self,
        attention_mask: Union[None, "torch.Tensor", "BlockMask"],
...
class BlenderbotModel(BlenderbotPreTrainedModel):
    ...
    @classmethod
    def from_pretrained(cls, pretrained_model_name_or_path: Union[None, str, os.PathLike], *model_args, **kwargs):
    ...
    def forward(
        ...
        encoder_outputs: Union[None, tuple, BaseModelOutput] = None,
        past_key_values: Optional[Cache] = None,
