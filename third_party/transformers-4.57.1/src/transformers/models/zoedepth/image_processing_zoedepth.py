...
class ZoeDepthImageProcessor(BaseImageProcessor):
    ...
    def post_process_depth_estimation(
        ...
        source_sizes: Union[None, TensorType, List[Tuple[int, int], None]] = None,
        target_sizes: Union[None, TensorType, List[Tuple[int, int], None]] = None,
        outputs_flipped: Union[None, "ZoeDepthDepthEstimatorOutput", None] = None,
        do_remove_padding: Union[None, bool, None] = None,
