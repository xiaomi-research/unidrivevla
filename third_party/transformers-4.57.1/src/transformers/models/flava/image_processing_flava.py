...
class FlavaImageProcessor(BaseImageProcessor):
    ...
    def __init__(
        ...
        image_mean: Union[None, float, Iterable[float]] = None,
        image_std: Union[None, float, Iterable[float]] = None,
        # Mask related params
        ...
        codebook_image_mean: Union[None, float, Iterable[float]] = None,
        codebook_image_std: Union[None, float, Iterable[float]] = None,
        **kwargs,
    ) -> None:
