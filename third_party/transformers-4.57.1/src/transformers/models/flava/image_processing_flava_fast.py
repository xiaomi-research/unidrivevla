...
class FlavaFastImageProcessorKwargs(DefaultFastImageProcessorKwargs):
    ...
    Args:
        ...
        codebook_image_mean (`Union[None, float, Iterable[float]]`, *optional*, defaults to `[0, 0, 0]`):
            The sequence of means for each channel, to be used when normalizing images for codebook. Can be overridden
            by the `codebook_image_mean` parameter in `preprocess`.
        codebook_image_std (`Union[None, float, Iterable[float]]`, *optional*, defaults to `[0.5, 0.5, 0.5]`):
    ...
    codebook_rescale_factor: Union[None, int, float]
    codebook_do_map_pixels: Optional[bool]
    codebook_do_normalize: Optional[bool]
    codebook_image_mean: Union[None, float, Iterable[float]]
    codebook_image_std: Union[None, float, Iterable[float]]
...
class FlavaImageProcessorFast(BaseImageProcessorFast):
    ...
    def _further_process_kwargs(
        ...
        image_mean: Union[None, float, List[float]] = None,
        image_std: Union[None, float, List[float]] = None,
        codebook_size: Optional[SizeDict] = None,
        codebook_crop_size: Optional[SizeDict] = None,
        codebook_image_mean: Union[None, float, List[float]] = None,
        codebook_image_std: Union[None, float, List[float]] = None,
    ...
    def _preprocess_image(
        ...
        do_normalize: bool,
        do_map_pixels: bool,
        image_mean: Union[None, float, List[float]],
        image_std: Union[None, float, List[float]],
        disable_grouping: Optional[bool],
        return_tensors: Union[None, str, TensorType],
    ) -> "torch.Tensor":
    ...
    def _preprocess(
        ...
        codebook_do_map_pixels: Optional[bool],
        codebook_do_normalize: Optional[bool],
        codebook_image_mean: Union[None, float, List[float]],
        codebook_image_std: Union[None, float, List[float]],
        disable_grouping: Optional[bool],
        return_tensors: Union[None, str, TensorType],
        **kwargs,
    ) -> BatchFeature:
