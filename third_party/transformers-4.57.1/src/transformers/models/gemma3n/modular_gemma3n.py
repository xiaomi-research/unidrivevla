...
class Gemma3nTextConfig(Gemma2Config, PretrainedConfig):
    ...
    def __init__(
        ...
        laurel_rank: int = 64,
        activation_sparsity_pattern: Union[None, float, Sequence[float]] = None,
        **kwargs,
    ):
...
class Gemma3nConfig(PretrainedConfig):
    ...
    def __init__(
        self,
        text_config: Union[None, Gemma3nTextConfig, Dict[str, Any]] = None,
        vision_config: Union[None, Gemma3nVisionConfig, Dict[str, Any]] = None,
        audio_config: Union[None, Gemma3nAudioConfig, Dict[str, Any]] = None,
