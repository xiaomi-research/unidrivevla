...
def get_resize_output_image_size(
    ...
    input_data_format: Union[None, str, ChannelDimension] = None,
) -> Tuple[int, int]:
    """
...
def get_max_height_width(
    images: List[np.ndarray], input_data_format: Union[None, str, ChannelDimension] = None
) -> List[int]:
    """
...
def make_pixel_mask(
    image: np.ndarray, output_size: Tuple[int, int], input_data_format: Union[None, str, ChannelDimension] = None
) -> np.ndarray:
    """
...
def prepare_coco_detection_annotation(
    ...
    input_data_format: Union[None, ChannelDimension, str] = None,
):
    """
...
class GroundingDinoImageProcessor(BaseImageProcessor):
    ...
    def prepare_annotation(
        ...
        masks_path: Union[None, str, pathlib.Path] = None,
        input_data_format: Union[None, str, ChannelDimension] = None,
    ) -> dict:
        """
    ...
    def rescale(
        ...
        data_format: Union[None, str, ChannelDimension] = None,
        input_data_format: Union[None, str, ChannelDimension] = None,
    ) -> np.ndarray:
        """
    ...
    def pad(
        ...
        annotations: Union[None, AnnotationType, List[AnnotationType]] = None,
        constant_values: Union[float, Iterable[float]] = 0,
    ...
    def preprocess(
        ...
        rescale_factor: Union[None, int, float] = None,
        do_normalize: Optional[bool] = None,
        do_convert_annotations: Optional[bool] = None,
        image_mean: Union[None, float, List[float]] = None,
        image_std: Union[None, float, List[float]] = None,
        do_pad: Optional[bool] = None,
        format: Union[None, str, AnnotationFormat] = None,
        return_tensors: Union[None, TensorType, str] = None,
    ...
    def post_process_object_detection(
        ...
        threshold: float = 0.1,
        target_sizes: Union[None, TensorType, List[tuple]] = None,
    ):
        """
