...
class TapexTokenizer(PreTrainedTokenizer):
    ...
    def __call__(
        ...
        query: Union[None, TextInput, List[TextInput]] = None,
        answer: Union[None, str, List[str]] = None,
    ...
    def batch_encode_plus(
        ...
        add_special_tokens: bool = True,
        padding: Union[bool, str, PaddingStrategy] = False,
        truncation: Union[None, bool, str] = None,
        max_length: Optional[int] = None,
        pad_to_multiple_of: Optional[int] = None,
        return_tensors: Union[None, str, TensorType] = None,
        return_token_type_ids: Optional[bool] = None,
    ...
    def truncate_table_rows(
        self, table_content: dict, question: str, answer: Union[None, str, List[str]] = None, max_length=None
    ):
        """
        Args:
        table_content:
