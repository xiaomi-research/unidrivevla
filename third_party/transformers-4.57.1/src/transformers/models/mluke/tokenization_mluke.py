...
class MLukeTokenizer(PreTrainedTokenizer):
    ...
    def __call__(
        ...
        text_pair: Union[None, TextInput, List[TextInput]] = None,
        entity_spans: Union[None, EntitySpanInput, List[EntitySpanInput]] = None,
        entity_spans_pair: Union[None, EntitySpanInput, List[EntitySpanInput]] = None,
        entities: Union[None, EntityInput, List[EntityInput]] = None,
        entities_pair: Union[None, EntityInput, List[EntityInput]] = None,
    ...
    def _encode_plus(
        ...
        text_pair: Union[None, TextInput] = None,
