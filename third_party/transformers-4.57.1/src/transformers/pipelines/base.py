...
def load_assistant_model(
    ...
    assistant_model: Union[None, str, "PreTrainedModel"],
...
class Pipeline(_ScikitCompat, PushToHubMixin):
    ...
    def __init__(
        ...
        framework: Optional[str] = None,
        task: str = "",
        device: Union[None, int, "torch.device"] = None,
...
class PipelineRegistry:
    ...
    def register_pipeline(
        ...
        task: str,
        pipeline_class: type,
        pt_model: Union[None, type, Tuple[type]] = None,
        tf_model: Union[None, type, Tuple[type]] = None,
