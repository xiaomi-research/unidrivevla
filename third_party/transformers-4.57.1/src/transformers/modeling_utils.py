...
def load_state_dict(
    ...
    map_location: Union[None, str, torch.device] = "cpu",
...
def _get_resolved_checkpoint_files(
    pretrained_model_name_or_path: Union[None, str, os.PathLike],
    subfolder: str,
...
def _get_dtype(
    cls,
    dtype: Union[None, str, torch.dtype, dict],
...
def _get_device_map(
    model: "PreTrainedModel",
    device_map: Union[None, dict, str],
...
class PreTrainedModel(nn.Module, EmbeddingAccessMixin, ModuleUtilsMixin, PushToHubMixin, PeftAdapterMixin):
    ...
    def from_pretrained(
        ...
        pretrained_model_name_or_path: Union[None, str, os.PathLike],
        *model_args,
        config: Union[None, PretrainedConfig, str, os.PathLike] = None,
