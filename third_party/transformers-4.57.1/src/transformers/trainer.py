...
class Trainer:
    ...
    def __init__(
        ...
        train_dataset: Union[None, Dataset, IterableDataset, "datasets.Dataset"] = None,
    ...
    def get_eval_dataloader(self, eval_dataset: Union[None, str, Dataset] = None) -> DataLoader:
        """
    ...
    def get_optimizer_group(self, param: Union[None, str, torch.nn.parameter.Parameter] = None):
        """
    ...
    def train(
        self,
        resume_from_checkpoint: Union[None, str, bool] = None,
    ...
    def hyperparameter_search(
        ...
        backend: Union[None, "str", HPSearchBackend] = None,
    ...
    def evaluate(
        self,
        eval_dataset: Union[None, Dataset, Dict[str, Dataset]] = None,
    ...
    def _get_num_items_in_batch(self, batch_samples: list, device: torch.device) -> Union[None, "torch.Tensor", int]:
        """
    ...
    ) -> Tuple[list, Union[None, "torch.Tensor", int]]:
        """
