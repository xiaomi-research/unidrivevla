...
from typing import Any, Callable, Dict, List, Literal, NewType, Optional, Tuple, Union, get_type_hints
...
def HfArg(
    *,
    aliases: Union[None, str, List[str]] = None,
...
class HfArgumentParser(ArgumentParser):
    ...
    def __init__(self, dataclass_types: Union[None, DataClassType, Iterable[DataClassType]] = None, **kwargs):
