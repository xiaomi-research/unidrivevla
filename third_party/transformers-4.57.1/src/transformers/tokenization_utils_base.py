...
class BatchEncoding(UserDict):
    ...
    def __init__(
        ...
        encoding: Union[None, EncodingFast, Sequence[EncodingFast]] = None,
    ...
    def convert_to_tensors(
        self, tensor_type: Union[None, str, TensorType] = None, prepend_batch_axis: bool = False
    ):
        """
...
class PreTrainedTokenizerBase(SpecialTokensMixin, PushToHubMixin):
    ...
    def encode(
        ...
        text_pair: Union[None, TextInput, PreTokenizedInput, EncodedInput] = None,
