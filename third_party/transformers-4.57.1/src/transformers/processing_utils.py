...
from typing import Any, Dict, List, Optional, Tuple, Type, TypedDict, TypeVar, Union
...
class ImagesKwargs(TypedDict, total=False):
    ...
    resample: Union[None, "PILImageResampling", int]
...
class VideosKwargs(TypedDict, total=False):
    ...
    video_metadata: Union[None, VideoMetadata, dict]
    fps: Union[None, int, float]
...
class AudioKwargs(TypedDict, total=False):
    ...
    padding: Union[None, bool, str, PaddingStrategy]
    max_length: Optional[int]
