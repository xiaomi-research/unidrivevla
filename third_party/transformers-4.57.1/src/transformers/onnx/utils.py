...
def get_preprocessor(model_name: str) -> Union[None, "AutoTokenizer", "AutoFeatureExtractor", "AutoProcessor"]:
    """
    ...
    Returns:
        `Union[None, AutoTokenizer, AutoFeatureExtractor, AutoProcessor]`:
