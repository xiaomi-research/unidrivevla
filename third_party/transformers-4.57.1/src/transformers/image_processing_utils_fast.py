...
class DefaultFastImageProcessorKwargs(TypedDict, total=False):
    ...
    resample: Union[None, "PILImageResampling", "F.InterpolationMode"]
    do_center_crop: Optional[bool]
    crop_size: Optional[Dict[str, int]]
    do_rescale: Optional[bool]
    rescale_factor: Union[None, int, float]
    ...
    input_data_format: Union[None, str, ChannelDimension]
...
class BaseImageProcessorFast(BaseImageProcessor):
    ...
    def _validate_preprocess_kwargs(
        ...
        rescale_factor: Optional[float] = None,
        do_normalize: Optional[bool] = None,
        image_mean: Union[None, float, Tuple[float]] = None,
        image_std: Union[None, float, Tuple[float]] = None,
        do_resize: Optional[bool] = None,
        size: Optional[SizeDict] = None,
        do_center_crop: Optional[bool] = None,
        crop_size: Optional[SizeDict] = None,
