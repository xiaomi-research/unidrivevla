...
from typing import Callable, Dict, Iterable, List, Mapping, NewType, Optional, Tuple, Union
...
) -> Tuple[Dict[Tuple[int, int], "torch.Tensor"], Dict[int, Tuple]]:
    """
...
def reorder_videos(
    ...
    grouped_videos_index: Dict[int, Tuple],
) -> List["torch.Tensor"]:
    """
