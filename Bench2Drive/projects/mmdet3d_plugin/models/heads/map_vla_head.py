...
class MapVLAHead(nn.Module):
    ...
    def forward(
        ...
        map_anchor: Optional[Tensor] = None,
        ...
        anchor = self.map_anchors.to(device=map_feat.device, dtype=map_feat.dtype)
        ...
        for layer_idx in range(max(self.refine_steps, 1)):
            ...
            if self.use_vision_fusion and feature_maps:
                ...
                # Norm after fusion (SparseDrive does norm after deformable)
                feat = self.norm(feat)
