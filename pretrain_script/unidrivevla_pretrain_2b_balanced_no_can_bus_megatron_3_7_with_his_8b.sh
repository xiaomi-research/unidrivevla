...
torchrun "${DISTRIBUTED_ARGS[@]}" \
    ...
    --model /high_perf_store3/world-model/zhuzhenxin/ckpts/Qwen3-VL-8B-Instruct/ \
    ...
    --dataset   '/high_perf_store3/world-model/yongkangli/UniDriveVLA/nuscenes_planning_qa_train_only_command_his_traj.jsonl#28130' \
                '/high_perf_store3/world-model/yongkangli/Dataset_vqa/DriveLM/drivelm_converted.with_prefix.jsonl' \
    ...
    --save megatron_output/Qwen3-VL-8B-Instruct-3-7-with-his \
    --save_interval 500 \
    ...
    --no_save_rng true \
    --dataset_num_proc 32 \
    --attention_backend flash > unidrivevla-pretrain-8b-3-7-with-his.txt 2>&1